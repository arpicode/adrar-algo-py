import utils
from exo3_4 import print_product_sign
...
def test_plus_by_zero_sould_be_positive() -> None:
    expectedOutput = MSG_POSITIVE
    print_product_sign(0.9, 0)
    assert utils.stdout_equals(expectedOutput)


def test_zero_by_plus_sould_be_positive() -> None:
    expectedOutput = MSG_POSITIVE
    print_product_sign(0, 2.3)
    assert utils.stdout_equals(expectedOutput)


def test_minus_by_zero_sould_be_positive() -> None:
    expectedOutput = MSG_POSITIVE
    print_product_sign(-20, 0.0)
    assert utils.stdout_equals(expectedOutput)


def test_zero_by_minus_sould_be_positive() -> None:
    expectedOutput = MSG_POSITIVE
    print_product_sign(0, -36.0)
    assert utils.stdout_equals(expectedOutput)


def test_zero_by_zero_sould_be_positive() -> None:
    expectedOutput = MSG_POSITIVE
    print_product_sign(0, 0)
    assert utils.stdout_equals(expectedOutput)


def test_minus_zero_by_minus_zero_sould_be_positive() -> None:
    expectedOutput = MSG_POSITIVE
